...
class TelaTeste extends JFrame implements ActionListener {
        ...
        LoginRegister acessoLgn = new LoginRegister();
        ...
        public TelaTeste(ArrayList<conta> contas, ArrayList<Livro> livros, ArrayList<audiobook> audiobook2, ArrayList<utensilios> utensilios) {
            super("Tela inicial");
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == mostrar) {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    ...
                    else if ((acessoLgn.checkEmail(email) != null || acessoLgn.isEmailValid(email) == false)
